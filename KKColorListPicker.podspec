Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/leoru/KKColorListPicker.git", :tag => "v0.2.4" }
  s.source_files = 'src/KKColorListPicker/**/*.{h,m}'
  s.resources    = 'src/KKColorListPicker/**/*.{xib,plist}'
end
